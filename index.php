...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Login | INVENTORI FEB-UI</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Aplikasi Persediaan souvenir THZ">
  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#000000" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/logo-feb-1.png" alt="Logo" height="100"> <b>Inventori Souvenir FEB-UI </b>
      </div><!-- /.login-logo -->
      <?php  
      ...
      <div class="login-box-body">
        <p class="login-box-msg"><i class="fa fa-user icon-title"></i> Selamat Datang</p>
        <br/>
