...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | FEB UI</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Aplikasi Persediaan souvenir FEB-UI">
    <meta name="author" content="Universitas Indonesia" />
    
    <!-- favicon -->
    <link rel="shortcut icon" href="assets/img/uii.png" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-5px;margin-right:3px" src="assets/img/uii.png" alt="Logo"> 
          <span style="font-size:12px">Inventori souvenir FEB-UI</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2022 - <a href="https://feb.ui.ac.id"> Faculty of Economics and Business, UI</a></strong>
      </footer>
    </div><!-- ./wrapper -->
